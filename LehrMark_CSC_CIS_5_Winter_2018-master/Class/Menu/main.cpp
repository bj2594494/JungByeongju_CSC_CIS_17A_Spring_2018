...
void problem1(){
    cout<<"Place Problem 1 solution here"<<endl;
}

void problem2(){
    cout<<"Place Problem 2 solution here"<<endl;
}

void problem3(){
    cout<<"Place Problem 3 solution here"<<endl;
}

void problem4(){
    cout<<"Place Problem 4 solution here"<<endl;
}

void problem5(){
    cout<<"Place Problem 5 solution here"<<endl;
}

void problem6(){
    cout<<"Place Problem 6 solution here"<<endl;
}